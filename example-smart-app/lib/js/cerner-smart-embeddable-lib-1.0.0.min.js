        ...
        _createClass(Application, [{
            ...
            value: function requestResize() {
                if (this.resizeConfig.customCal) {
                    ...
                    var width = (0,
                    _dimension.calculateWidth)(this.resizeConfig.WidthCalculationMethod);
                    this.JSONRPC.notification("resize", [null, width + "px"])
                } else {
                    var height = (0,
                    _dimension.calculateHeight)(this.resizeConfig.heightCalculationMethod);
            ...
            value: function verifyChallenge(secretAttempt) {
                ...
                if (typeof this.secret === "string" && (0,
                _string.fixedTimeCompare)(this.secret, secretAttempt)) {
                    authorize()
